 ...
 * -------------------------------------------------------
 * Control de Inventario y Catálogo de Productos / Libros.
 * 
 * Permite:
...
export default function InventarioPage() {
  ...
  // Handlers para Crear/Editar Producto
  ...
  // Handlers para Ajuste/Entrada de Stock
    ...
    <div className="space-y-6 animate-fade-in">
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {busqueda ? 'No se encontraron resultados para tu búsqueda.' : 'Crea tu primer libro o producto con el botón superior.'}
            </p>
            {!busqueda && (
              <Button variant="primary" size="sm" className="mt-4" onClick={abrirCrearProducto}>
                        ...
                        <td className="px-4 py-3 text-right">
                          <div className="flex items-center justify-end gap-1">
                            <Button
                              ...
                              title="Añadir stock o registrar entrada/salida"
                            >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ej: Matemáticas 1er Grado — Edición 2026"
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              >
                ...
                <option value="salida">- Salida / Merma (Resta stock)</option>
              </select>
            </div>
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-foreground">
              Motivo / Detalle del Movimiento
            </label>
            <input
              type="text"
              value={motivoAjuste}
              onChange={(e) => setMotivoAjuste(e.target.value)}
              placeholder="Ej: Lote recibido de imprenta #450"
              className="w-full rounded-xl border border-border bg-background px-3 py-2 text-sm focus:border-primary-accent/50 focus:outline-none"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-2 pt-2">
            ...
            <Button variant="primary" onClick={handleGuardarMovimientoStock} disabled={guardandoStock}>
              {guardandoStock ? 'Registrando...' : 'Confirmar Movimiento'}
            </Button>
          </div>
        </div>
      </Modal>
